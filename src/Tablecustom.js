...
class TableCustom extends React.Component{
    ...
    async getMatchedPrice(vm_to_match){
        ...
        priceData.price = RESPONSE_DATA[0]["price per hour USD"]
    ...
    renderTableHeader = () => {
        ...
        return(
            <TableRow>
                ...
                <TableCell className="tableHeadFont" key={tableHeaders[1]}>{tableHeaders[1]}</TableCell>
                <TableCell className="tableHeadFont" key={tableHeaders[2]}>{tableHeaders[2]}</TableCell>
                <TableCell className="tableHeadFont" key={tableHeaders[4]}>{tableHeaders[4]}</TableCell>
                <TableCell className="tableHeadFont" key={tableHeaders[5]}>{tableHeaders[5]}</TableCell>
            </TableRow>
        );
    }
        ...
        return this.state.dataStore.map(data => {
            ...
            return (
                <TableRow key={i++}>
                    ...
                    <TableCell align="right">{data.AWS_matches[0]}</TableCell>
                    <TableCell key="price" align="right">{this.state.priceCache.price}</TableCell>
                </TableRow>
            )
        })
    }
